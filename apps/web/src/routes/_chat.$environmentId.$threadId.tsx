...
const DATABASE_INLINE_SIDEBAR_MAX_WIDTH = 44 * 16;
...
const RightPanelInlineSidebar = (props: {
  ...
  const { open, onClose, defaultWidth, minWidth, maxWidth, storageKey, children } = props;
    ...
    return (
      <>
        ...
        <RightPanelInlineSidebar
          ...
          maxWidth={
            activeRightPanel === "database"
              ? DATABASE_INLINE_SIDEBAR_MAX_WIDTH
